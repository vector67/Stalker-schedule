...
if(isset($_POST['add'])&&$_POST['add']=="true"){
	...
	$query = "Delete from `timepeople`  where `tid` = '".$tid."' and `pid`='".mysql_escape_string($_POST['pid'])."'";
...
<div class = "container">
	<div class="heading">
		<h1>Delete free time!</h1>
		<p>Use the form below to delete you free times, just select the time slot and name from the list and then click "Delete free time"</p>
		<?php echo (($success==2)?"<p style='color:#CCFFCC;'>Successfully deleted that time.</p>":(($success==3)?"<p style='color:#FFCCCC;'>Was not successfully deleted.</p>":""));?>
	</div>
	<div class="formcontainer">
		<form method="post" action="#">
			...
			<input type="submit" class="button" value="Delete free time"/>
		</form>
	</div>
</div>
</body>